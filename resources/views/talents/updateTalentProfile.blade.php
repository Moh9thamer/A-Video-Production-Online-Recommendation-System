                ...
                <div class="col-lg-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="updateTalent" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mx-auto" style="width: 200px;">
                                    ...
                                    <button type="button" class="btn btn-dark"><a href="talentPage" style="color: white ; text-decoration: none;">Cancel</a></button>
                                </div>
