@extends('layouts/project',['title'=>'Crew Requests'])
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            The requests that has been sent to talents to join the project
        </div>
        <div class="card-body">
            ...
            <div class="container mx-auto mt-4">
                ...
                <div class="col-md-4">
                    <div class="cards" style="width: 18rem; ; ">
                        ...
                        <div class="card-body">
                            ...
                            @if($talent['status'] == 'pending')
                                <h5 style="text-transform: capitalize; "  ><strong> {{$talent['status']}}</strong></h5>

                            @else
                                <h5 style="text-transform: capitalize; color: red "  ><strong> {{$talent['status']}}</strong></h5>
                                @endif
                        </div>
                    </div>
                </div>
                    @empty
                            ...
                            <h2 style="color: darkgray"  class="text-center font-weight-light">There are no pending hire requests </h2>
